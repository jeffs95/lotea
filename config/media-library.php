...
return [
     ...
     */
    /*
     * Rutas relativas en vez de absolutas contra APP_URL: en el portal de un
     * cliente con dominio propio, una URL absoluta pondría «lotea» en el src
     * de las fotos de sus propios carros. Ver App\Support\UrlDeMediaRelativa.
     */
    'url_generator' => UrlDeMediaRelativa::class,
