        ...
        <div class="grid gap-8 lg:grid-cols-[1fr_380px]">
            ...
            <div class="space-y-5 lg:sticky lg:top-20 lg:self-start">
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    @if ($whatsapp)
                        <a href="https://wa.me/502{{ $whatsapp }}?text={{ $mensajeWa }}" target="_blank" rel="noopener"
                ...
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    <h2 class="text-base font-bold">Calculá tu cuota</h2>
                ...
                <div id="contacto" class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    @else
                        <h2 class="text-base font-bold">¿Te interesa? Dejanos tus datos</h2>
