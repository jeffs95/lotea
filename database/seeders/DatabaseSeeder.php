...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Tenancy::comoEmpresa($empresa, function () use ($dueno) {
            ...
            if (Unidad::count() === 0) {
                $this->call([UnidadesDemoSeeder::class, CostosDemoSeeder::class, VentasDemoSeeder::class, EmpleadosDemoSeeder::class, CajasDemoSeeder::class, TallerDemoSeeder::class, CarteraDemoSeeder::class]);
            }
        });
